                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="contact" value="{{ old('contact') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('newsletter') ? ' has-error' : '' }}">
                            ...
                            <label for="name" class="col-md-4 control-label">Apply To Newsletter</label>
                            <div class="col-md-6">
                                <input id="name" type="checkbox" class="form-control" name="newsletter" checked="{{ old('newsletter') }}">

                                @if ($errors->has('newsletter'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('newletter') }}</strong>
                                    </span>
                                @endif
                            </div>
